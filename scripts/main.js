...
async function open_terminal(){
    ...
    createCode (" Type all","To see all the commands");
...
async function getInputValue(){
    ...
    if(value === "all"){
        trueValue(value);
        createCode("Type help","For Help")
        createCode("Type about","Details of XShell")
        createCode("Type clear","To clear the terminal")
        createCode("Type server-info","Details of all the servers")
        createCode("Type server-ps","Showing all the passwords of the servers")
        createCode("Type pc-info","Showing the PC information ")
        createCode("Type pc-ps","Showing the passwords of the PC users in IT")
        createCode("Type email-ps","Showing the passwords of the email used in IT")
        createCode("Type camera-ip","Showing the NVR of Patna and Pune")
        createCode("Type pan-details","Showing the PAN details of the Madam and CCEL")
    }
    else if(value === "about"){
        trueValue(value);
        ...
        createText("Package: 3.3")
        createText("Creator: Aakarsh Srivastawa")
        ...
        createText("192.168.0.246 : Patna Server")
        createText("192.168.0.247 : Pune Server")
        ...
        trueValue(value);
        createText("IT Department : Aakarsh, Sinha")
        createText("Admin : Amit Kumar")
    }
    else if(value === "pc-ps"){
        trueValue(value);
